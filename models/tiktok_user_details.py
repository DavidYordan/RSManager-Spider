...
class TikTokUserDetails(Base):
    __tablename__ = 'tiktok_user_details'

    tiktok_id = Column(String(50), primary_key=True)  # TikTok平台的用户ID
    tiktok_account = Column(String(100))  # TikTok账号
